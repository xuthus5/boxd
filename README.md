...
- **Observability**: kernel/app logs with copy/export and denser mobile filters, TCP/UDP connections with source/network/inbound/process, compact toolbar, search/sort/export, outbound/rule aggregation, and group close
