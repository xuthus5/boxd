...
- **Configuration safety**: successful applies retain bounded local snapshots; the dashboard can restore a known-good sing-box config through validation, restart, and automatic rollback on failure
