...
- **Configuration safety**: successful applies retain bounded local snapshots; the dashboard previews path-level differences before restoring a known-good sing-box config through validation, restart, and automatic rollback on failure
