...
- **Nodes & subscriptions**: Clash YAML + base64 subscriptions, traffic/expiry, failed-first + retry, node search, latency color bands + history sparkline, runtime groups, probes
