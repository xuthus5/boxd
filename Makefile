...
BUILD_TAGS := embed_ui with_gvisor with_quic with_dhcp with_wireguard with_utls with_acme with_clash_api with_tailscale with_openvpn with_openconnect with_cloudflared with_usbip with_ccm with_ocm with_v2ray_api
