...
const issueLabelKeys: Record<string, string> = {
  ...
  missing_tag: "configDiagnostics.issueLabels.missingTag",
  empty_group: "configDiagnostics.issueLabels.emptyGroup",
  invalid_group_default: "configDiagnostics.issueLabels.invalidGroupDefault",
  outbound_dependency_cycle: "configDiagnostics.issueLabels.outboundDependencyCycle",
  dns_dependency_cycle: "configDiagnostics.issueLabels.dnsDependencyCycle",
  invalid_dns_default: "configDiagnostics.issueLabels.invalidDNSDefault",
  multiple_fakeip_dns_servers: "configDiagnostics.issueLabels.multipleFakeIPDNSServers",
...
const issueHintKeys: Record<string, string> = {
  ...
  missing_tag: "configDiagnostics.issueHints.missingTag",
  empty_group: "configDiagnostics.issueHints.emptyGroup",
  invalid_group_default: "configDiagnostics.issueHints.invalidGroupDefault",
  outbound_dependency_cycle: "configDiagnostics.issueHints.outboundDependencyCycle",
  dns_dependency_cycle: "configDiagnostics.issueHints.dnsDependencyCycle",
  invalid_dns_default: "configDiagnostics.issueHints.invalidDNSDefault",
  multiple_fakeip_dns_servers: "configDiagnostics.issueHints.multipleFakeIPDNSServers",
