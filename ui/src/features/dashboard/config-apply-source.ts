...
const sourceKeys: Record<string, string> = {
  ...
  validate_certificate: "sourceValidateCertificate",
  validate_services: "sourceValidateServices",
  validate_log: "sourceValidateLog",
...
const sourceHrefs: Record<string, string> = {
  ...
  validate_certificate: "/advanced/certificate",
  validate_services: "/advanced/services",
  validate_log: "/advanced/log",
