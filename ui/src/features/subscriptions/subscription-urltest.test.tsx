...
describe("subscription URLTest overrides", () => {
  it("locks URLTest fields while inheriting globals and only enables them after enabling", async () => {
    ...
    expect(screen.getByLabelText("URLTest 测试地址")).toBeDisabled()
    expect(screen.getByLabelText("URLTest 测试地址")).toHaveValue(defaults.url)
    ...
    expect(screen.getByLabelText("URLTest 测试地址")).toBeEnabled()
    expect(screen.getByLabelText("URLTest 测试地址")).toHaveValue("")
  ...
  it("hides URLTest fields when disabled and explains selector fallback", async () => {
    ...
    expect(screen.queryByLabelText("URLTest 测试地址")).not.toBeInTheDocument()
